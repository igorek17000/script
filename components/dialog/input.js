            ...
            <div className="min-h-screen px-4 text-center">
                ...
                <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-[#1c1c1c] dark:bg-white shadow-xl">
                    ...
                    <div className="mt-2">
                        <button
                            type="button"
                            className="px-10 py-2 text-sm font-medium bg-gradient-to-b from-[#1E1E1E] to-[#1E1E1E] text-black bg-blue-100 border border-transparent rounded-full hover:bg-blue-200"
