...
useEffect(()=>{
    ...
    return (
        ...
        <Disclosure as="nav" className="z-50 fixed w-full h-[104px] transition-all bg-[#1E1E1E] dark:bg-white dark:border-b dark:border-gray-200">
        {({ open }) => (
...
<button className='rounded-md bg-gradient-to-b  m-6 from-[#1E1E1E] to-[#1E1E1E] text-black text-base  sm:px-2 shadow-lg' onClick={connectMetamask}>Connect Wallet</button>
}
                                </div>
                            </div>
                        </div>
